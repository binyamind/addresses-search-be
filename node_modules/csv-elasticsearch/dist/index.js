...
__nccwpck_require__.d(__webpack_exports__, {
  "importCsv": () => (/* binding */ importCsv)
});

;// CONCATENATED MODULE: external "stream"
const external_stream_namespaceObject = require("stream");
;// CONCATENATED MODULE: ./node_modules/csv-parse/lib/ResizeableBuffer.js
...
/* harmony default export */ const lib_ResizeableBuffer = (ResizeableBuffer);

;// CONCATENATED MODULE: ./node_modules/csv-parse/lib/index.js
...
class Parser extends external_stream_namespaceObject.Transform {
  constructor(opts = {}){
  ...
  __normalizeOptions(opts){
    ...
    this.state = {
      ...
      field: new lib_ResizeableBuffer(20),
      ...
      quoting: false,
      stop: false,
      rawBuffer: new lib_ResizeableBuffer(100),
      record: [],
...
function importCsv(options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { body: countBody } = yield client.count({ index });
        return {
